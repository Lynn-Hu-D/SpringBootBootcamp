...
public class GradeServiceTest {
    ...
    // inject the dependency mock to the class to be tested
    @InjectMocks
    private GradeService gradeService;

 
    // step1: @Test annotation
    @Test
    public void getGradesFromRepoTest() {
        //step2: mock the data that needed to carry out
        ...
        //step3: check if the method behave correctly
